...
class ConnectionManager @Inject constructor() {
    ...
    private val sshProxy: SSHConnectionConfig by lazy {
        SSHConnectionConfig(host = preferenceHandler.getValue(PreferenceHandler.SSH_PROXY_HOST),
    ...
    private val sshMain: SSHConnectionConfig by lazy {
